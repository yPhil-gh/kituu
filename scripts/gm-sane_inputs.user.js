...
// GM_addStyle("input { background: none; background-color: black !important; }");
// GM_addStyle("input { color: red !important; }");
...
GM_addStyle("input[type=text] { background-color: black; color: green; !important; }");
