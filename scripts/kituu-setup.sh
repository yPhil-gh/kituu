...
packages="zsh curl gcc autoconf automake texinfo libtool libgtk-3-dev emacs zile wget bzr git perl-doc sox bbdb htop xfce4 bc thunderbird gimp inkscape wl"
