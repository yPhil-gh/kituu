...
packages="zsh curl gcc autoconf automake texinfo libc6-dev libjpeg62-dev libncurses5-dev libpng-dev libgtk2.0.0 emacs zile wget bzr git perl-doc sox bbdb htop xfce4 bc thunderbird gimp inkscape wl"
